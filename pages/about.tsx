...
import { Container, H1, H4, P } from '../components/atoms';
...
export default function AboutUs() {
  return (
    <Layout
      pageTitle="About"
      metaTitle="A Little about Sydney's First Vegan Lebanese Restaurant"
    >
      <Container>
        ...
        <P>
          ...
          health benefits of a plant-fuelled life we can help more people
          nourish their bodies, while reducing our footprint on the planet and
